/*
 * This code was created by Mu Beer Folly (@MuBeerFolly) for the Spectre Prision project
	 ...
	 EntityPlayer = ig.Entity.extend({
        ...
        if( ig.input.pressed('speak') ) {
          if(!ig.game.getEntityByName('playerBubble')) {
            var parameters = {text: 'I pwn.', tracks: 'player1', margin: 0, lifeSpan: 5, shape: 'square', name: 'playerBubble'};
