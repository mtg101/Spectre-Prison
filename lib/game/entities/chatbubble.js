ig.module(
  ...
  'impact.font'
    ...
    //Opacity - 0.1 - 1
    opacity: '0.5',
    //Name (or object) of the entity chat pubble tracks. 
    tracks: null,
    ...
    update: function() {
	    ...
	    */
  	  ...
  	  //Note: clearly would be more efficient to store the tracked object rather than do all this lookup
      // every update(), but this retians the original API (ie can change name of tracked object at any point)
      ...
      if(typeof this.tracks == 'string') {
	    ...
	    if ( !follows ) {
        console.log('EntityChatbubble: Nothing to follow. Kill().')
		    this.kill();
	    } else {
    ...
    draw: function() {
      ...
      if ( !follows ) {
        console.log('Can\'t seem to find what I\'m supposed to follow. Shouldn\'t I call this.kill()?');
        return;
      }
