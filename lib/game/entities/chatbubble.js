ig.module(
  ...
  'impact.font'
    ...
    draw: function() {
       ...
       console.log('screen: ' + parseInt(ig.game.screen.x) + ',' + parseInt(ig.game.screen.y)
                   + ', draw: ' + parseInt(x) + ',' + parseInt(y)
                   + ', this: ' + parseInt(this.pos.x) + ',' + parseInt(this.pos.y)
                   + ', follows: ' + parseInt(follows.pos.x) + ',' + parseInt(follows.pos.y)                   
                   );
